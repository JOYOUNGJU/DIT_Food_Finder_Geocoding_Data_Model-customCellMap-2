...
class MyTableViewController: UITableViewController,UISearchBarDelegate {
    var currentFoodArray = [FoodStore]() // update table
...
//        cell.foodStoreCellTel.text = foodStoreTel[indexPath.row]
        ...
        cell.foodStoreCellName.text = currentFoodArray[indexPath.row].name
        cell.foodStoreCellImage.image = UIImage(named: currentFoodArray[indexPath.row].image)
        cell.foodStoreCellAddress.text = currentFoodArray[indexPath.row].address
        cell.foodStoreCellTel.text = currentFoodArray[indexPath.row].tel
    ...
    func searchBar(_ searchBar: UISearchBar, textDidChange searchText: String) {
        ...
        currentFoodArray = foodStores.filter ({ foodStores -> Bool in
            guard let text = searchBar.text else {return false}
            return foodStores.name.contains(text)
        })
